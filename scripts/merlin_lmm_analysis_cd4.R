...
df = read.csv("/Users/alaa/Documents/ucsf/data/suliman/merlin/meta/experiment2_cd4_count_lmm_data.csv")
head(df)
...
model <- lmer(sqrt_cd4_count ~ treatment_group * factor(timepoint) + (1 | patient_id), data = df)
...
write.csv(fixed_effects, "/Users/alaa/Documents/ucsf/data/suliman/merlin/phenotype/experiment2_cd4_count_lmm_fixed_effects_summary_v2.csv", row.names = TRUE)
...
write.csv(random_effects, "/Users/alaa/Documents/ucsf/data/suliman/merlin/phenotype/experiment2_cd4_count_lmm_random_effects_summary_v2.csv", row.names = FALSE)
...
write.csv(anova_df, "/Users/alaa/Documents/ucsf/data/suliman/merlin/phenotype/experiment2_cd4_count_lmm_anova_results_v2.csv", row.names = TRUE)
...
p <- ggplot() +
  ...
  geom_line(data = df, 
            aes(x = timepoint_num, y = sqrt_cd4_count, 
  ...
  geom_line(data = emm_df, 
            ...
            size = 1.5) +
  labs(x = "Timepoint", y = "Sqrt CD4 Count",
